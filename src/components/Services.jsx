...
const Services = () => {
  return (
   <section className='max-w-7xl mx-auto border-b-2' id='services'>
    <div className='my-20'>
        <h2 className='text-xl lg:text-3xl tracking-tight text-center uppercase mb-20'> Our Home Renovation Services

        </h2>
        {SERVICES_CONTENT.map((service, index) => (
            <div key={index} className='flex flex-col lg:flex-row mx-4 mb-12'>
