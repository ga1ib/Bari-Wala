  ...
  return (
    <section className='max-w-7xl mx-auto' id='contact'>
      <div className='my-20'>
        ...
        <p className='max-w-2xl mb-12 text-lg text-center mx-auto'>
          {CONTACT_INFO.text}
        </p>
        <div className='flex flex-col lg:flex-row justify-around mr-4'>
          <div className='flex mb-8 lg:mb-0'>
            <RiMailSendLine className='text-3xl mr-4'/>
            <div>
